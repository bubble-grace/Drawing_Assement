...
class Manager extends InteractiveObject {
    ...
    mUp(e) {
        ...
        if (this.readytodraw) {
            if (name === "Ellipse") {
                ...
                let temp = new Star(this.xStart, this.yStart, this.w, this.h, colArray[1][4]);
                this.objectSet.push(temp);
                this.update()
            }
            else if (name === "Heart") {
                let temp = new Heart(this.xStart, this.yStart, this.w, this.h, colArray[1][4]);
                this.objectSet.push(temp);
                this.update()
            }
            this.readytodraw = false
    ...
    update(){
        basicRect(rect_startx,rect_starty, rect_width, rect_height,colArray[0][1])
